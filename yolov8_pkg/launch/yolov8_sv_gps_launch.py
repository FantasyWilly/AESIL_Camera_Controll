...
def generate_launch_description():
    ...
    config_file_path = os.path.join(
        ...
        'config',
        'yolov8_sv_gps.yaml'                            # 與上面建立的 YAML 檔名一致
    )

    return LaunchDescription([
        Node(
            package='yolov8_pkg',                           # package 名稱
            executable='yolov8_sv_gps_node',                # 在 setup.py 裡註冊的執行檔或 entry point 名稱
            name='yolov8_sv_gps_node',                      # 對節點重新命名
            output='screen',
